          ...
          <div className="prose prose-invert prose-purple max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="text-gray-300 space-y-2 ml-6">
                ...
                <li>• <strong>Profile Data:</strong> Display name, profile picture, and user preferences</li>
                <li>• <strong>Payment Information:</strong> Billing details for credit purchases (processed securely through third-party payment providers)</li>
                <li>• <strong>Contact Information:</strong> When you reach out to our support team</li>
              </ul>
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">Content Data</h3>
              <ul className="text-gray-300 space-y-2 ml-6">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-3">We use your information for the following purposes:</p>
              <ul className="text-gray-300 space-y-2 ml-6">
                <li>• <strong>Service Provision:</strong> To provide and maintain our AI video generation services</li>
                <li>• <strong>Account Management:</strong> To create and manage your user account</li>
                <li>• <strong>Payment Processing:</strong> To process credit purchases and manage billing</li>
                <li>• <strong>Content Generation:</strong> To process your requests and generate AI videos and avatars</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-3">We do not sell, trade, or rent your personal information. We may share information in the following circumstances:</p>
              ...
              <p className="text-gray-300">We may disclose your information if required by law or in response to valid legal requests from authorities.</p>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">Business Transfers</h3>
              <p className="text-gray-300">In the event of a merger, acquisition, or asset sale, your information may be transferred as part of that transaction.</p>
            </section>

            {/* Data Security */}
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">Data Security</h2>
              <p className="text-gray-300 mb-3">We implement industry-standard security measures to protect your information:</p>
              <ul className="text-gray-300 space-y-2 ml-6">
            ...
            <section className="mb-8">
              ...
              <ul className="text-gray-300 space-y-2 ml-6">
                ...
                <li>• <strong>Generated Content:</strong> Stored according to your account settings and service requirements</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-3">Our app may contain links to third-party services or integrate with external platforms:</p>
              <ul className="text-gray-300 space-y-2 ml-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start text-gray-300">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">privacy@clonex.app</p>
                    </div>
                  </div>
                </div>
              </div>
